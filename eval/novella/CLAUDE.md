...
facts. A phase may not be built until its load-bearing gates are verified (green)
in `SPEC.md`. If reality and `SPEC.md` disagree, run `/spec` to reconcile. Do not
